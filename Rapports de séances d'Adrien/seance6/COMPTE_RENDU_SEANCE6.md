...
Nous avons finalisé la réalisation d’un fichier vectoriel en svg sur Inkscape délimitant nos gravures et découpes pour la partie haute du flipper puis nous avons utilisé une découpeuse laser.
...
J’ai dessiné l'emplacement des différents capteurs infrarouges qui seront utilisés sur la planche de jeu afin de positionner les trous dans lesquels nous allons insérer des plaques de plexiglass et Redha les a tracés sur Inkscape, nous avons ensuite pu les percer dans nos planches. (Les emplacements sont désignés par des cercles sur l'image de la maquette en bas du compte rendu).
