...
Durant le temps restant avant la séance j’ai continué le schéma électronique commencé à la séance précédente sur le logiciel Fritzing et j’ai fixé les différents composants électroniques sous la planche. Tout en réglent le convertisseur avec un multimètre pour qu’il transforme la tension de 24V en une tension de 5V en sortie afin d'alimenter l'arduino et les composants nécessitant 5V.
